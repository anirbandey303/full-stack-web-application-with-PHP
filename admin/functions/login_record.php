...
//Check for new user
	...
	if ($flag == 0)
	{
		...
		$insert_q  = "INSERT INTO `myusers` (`user_id`, `fb_id`, `first_name`, `last_name`, `email`, `picture`, `gender`, `joined`, `source`) VALUES (NULL, '".$_SESSION['userData']['id']."', '".$_SESSION['userData']['first_name']."', '".$_SESSION['userData']['last_name']."', '".$_SESSION['userData']['email']."', '".$_SESSION['userData']['picture']['url']."', '".$_SESSION['userData']['gender']."', NOW(), 'facebook');";
